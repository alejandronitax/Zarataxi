 ...
 * Use the {@link DestinyFragment#newInstance} factory method to
...
public class DestinyFragment extends Fragment {
     ...
     * @return A new instance of fragment DestinyFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static DestinyFragment newInstance(String param1, String param2) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        button_destiny.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View view) {

                NavHostFragment.findNavController(new DirectionFragment())
